    ...
    <ul class="nav-items" on:click={() => (closed = true)}>
      <li>
        <a href="/" class="nav-item"
          ><svg
            ...
            />
          </svg> <span class="label">Bejelentkezés</span></a
        >
      </li>
      <li>
        <a href="/registration" class="nav-item"
          ><svg
            ...
            />
          </svg> <span class="label">Regisztráció</span></a
        >
      </li>
      <li>
        <a href="https://tvmaci.mora.u-szeged.hu" class="nav-item"
          ><svg
            ...
            />
          </svg> <span class="label">TV maci</span></a
        >
      </li>
      <li>
        <a href="https://zulip.mora.u-szeged.hu" class="nav-item"
          ><svg
            ...
            />
          </svg> <span class="label">Zulip</span></a
        >
      </li>
      <li>
        <a href="https://speedtest.net" target="_blank" rel="noopener noreferrer" class="nav-item"
          ><svg width="32" height="25.6" viewBox="0 0 640 512" fill="currentColor"
            ><path
              id="path-0"
            ...
            /></svg
          > <span class="label">Speedtest</span></a
        >
      </li>
      <li>
        <a href="https://support.mora.u-szeged.hu" class="nav-item"
          ><svg
            ...
            />
          </svg> <span class="label">Support</span></a
        >
      </li>
      <li>
        <a href="https://drive.mora.u-szeged.hu" class="nav-item"
          ><svg
            ...
            />
          </svg> <span class="label">Tárhely</span></a
        >
      </li>
      <li>
        <a href="/experimental" class="nav-item"
          ><svg width="32" height="32" viewBox="0 0 512 512" fill="currentColor"
            ><g
              ...
              /></g
            ></svg
          > <span class="label">Fejlesztés alatt</span></a
        >
      </li>
      <li class="seperator" />
      <Install bind:prompt>
        <li>
          <a href="./" class="nav-item" on:click={prompt}
            ><svg width="32" height="32" viewBox="0 0 512 512" fill="currentColor"
              ...
              /></svg
            > <span class="label">Telepítés</span></a
          >
        </li>
      </Install>
      <li>
      ...
      <li id="nav-theme">
        ...
        <a
          ...
          ><svg width="32" height="28.444444444444443" viewBox="0 0 576 512" fill="currentColor"
            ><path
